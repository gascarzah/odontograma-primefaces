...
//		console.debug("sPiezaMarcada ="+sPiezaMarcada);
//		console.debug("sCaraMarcada ="+sCaraMarcada);
//		console.debug("sColorMarcada ="+sColorMarcada);
//		console.debug("sPiezaMarcadaInicial ="+sPiezaMarcadaInicial);
//		console.debug("sCaraMarcadaInicial ="+sCaraMarcadaInicial);
//		console.debug("sColorMarcadaInicial ="+sColorMarcadaInicial);
...
//			console.debug("tam piezas marcardas "+piezasMarcadas);
			...
			$("#vPiezasMarcadas").val(piezasMarcadas) ;
//			self.trigger('tratamientoAplicado.odontograma', tratamiento);
//			console.debug("tam actual  ====>>> "+$("#vDientes").val());
//			console.debug("tam piezas marcardas ====>>> "+$("#vPiezasMarcadas").val());
	 }	
